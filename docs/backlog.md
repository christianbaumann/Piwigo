...
- (open) provenance: E2E spec for the Batch Manager move prompt — "the prompt appears and its three choices behave as labelled" was never verified by anyone. **No longer blocked** (the install was resynchronised 2026-08-29); it is writable now (Phase 9 manual step 1)
